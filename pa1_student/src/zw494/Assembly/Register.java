...
public class Register extends Arg implements Comparable<Register> {
    ...
    // the goal of the register allocation algorithm is to make all registers with "name" only to be a concrete register
    public enum regNames {
        rax, rcx, rdx, rbx, rsi, rdi, rsp, rbp, r8, r9, r10, r11, r12, r13, r14, r15, al, dl
    }

    // constant lists of all registers available
    ...
    private regNames name; // the color of the register
    private String argName; // the name of the register

    public int degree = 0; // the degree of the register
    ...
    public Register alias; // an alias of this register

    public Type type; // the stage of optimization that this register is in
    ...
    // A coarse estimation of register priority
