...
/**
 * The general interface for all data flow analysis, including copy propagation, reaching definition, live variable analysis, and so on.
 */
public abstract class DataFlowAnal<N, E> {

    // the in sets, out sets, and the cfg graph.
    Map<N, E> in;
    Map<N, E> out;
    ...
    // whether the edges have the same element.
    public abstract boolean hasSameElt(E t1, E t2);

    // a condition to operate on the list of nodes.
    public abstract void cond(List<N> lst);

    /**
     * The backward worklist algorithm.
     */
    ...
    /**
     * The forward worklist algorithm.
     */
